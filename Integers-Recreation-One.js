...
// or a string. The subarrays (or tuples or Pairs) will have two elements: first 
// the number the squared divisors of which is a square and then the sum of 
// the squared divisors.
// Example:
