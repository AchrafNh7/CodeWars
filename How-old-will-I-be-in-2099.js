...
// until he would be born, so your function needs to work with both dates in 
...
function  calculateAge(year,years) {
    return year < years 
                      ? `You are ${years-year===1 ? 1+" year" : years-year+" years"} old.`
                      : year > years ?
                        `You will be born in ${year-years===1 ? 1+" year" : year-years+" years"}.`
