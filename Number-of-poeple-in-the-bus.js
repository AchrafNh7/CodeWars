...
// each bus stop.You are provided with a list (or array) of integer pairs. 
...
// at a bus stop.Your task is to return the number of people who are still on 
// the bus after the last bus stop (after the last array). Even though it is 
