...
// listed below so you can copy and paste! Write a 'welcome' function that 
// takes a parameter 'language', with a type String, and returns a greeting - 
...
, "welsh", "Croeso"]
  ...
  return arr.includes(language) ? arr[arr.indexOf(language)+1]
                                : 'Welcome'
}