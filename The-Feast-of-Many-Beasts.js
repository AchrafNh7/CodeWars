...
// returns true or false to indicate whether the beast is allowed to bring 
...
const feast = (beast, dish) => beast.charAt(0) == dish.charAt(0) && beast.endsWith(dish.charAt(dish.length - 1)) 
